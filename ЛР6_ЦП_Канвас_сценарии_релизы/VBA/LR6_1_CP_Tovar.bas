Attribute VB_Name = "LR6_1_CP_Tovar"
' =====================================================================
' ЛР6 «Электронный бизнес», NotaCode. Методика 6.1 Ценностное предложение и цифровой товар.
' Выполнила: Хаджинова К.
' Назначение: заполнить Excel-шаблон «Шаблон_формулирования_ценностного_предложения_и_цифрового_товара.xlsx»
'   данными NotaCode из файла VBA\data\lr6_1.tsv (UTF-8, выгружен скриптом Python\lr6_calc.py),
...
'   2) Файл lr6_1.tsv ищется рядом с копией, в подпапке data; иначе макрос откроет диалог выбора.
'   3) Alt+F11 -> File -> Import File -> LR6_1_CP_Tovar.bas.
...
Public Sub Main()
    RunLoad "lr6_1.tsv"
    AddBarChart ActiveWorkbook.Worksheets(U("\u0414\u0430\u0448\u0431\u043E\u0440\u0434")), ActiveWorkbook.Worksheets(U("\u041F\u0440\u043E\u0431\u043B\u0435\u043C\u044B \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432")), "A5:A12", "K5:K12", U("\u0418\u043D\u0434\u0435\u043A\u0441 \u043F\u0440\u043E\u0431\u043B\u0435\u043C\u044B (0-100)"), 20, 260
    MsgBox "LR6 LR6_1_CP_Tovar: OK", vbInformation
End Sub
