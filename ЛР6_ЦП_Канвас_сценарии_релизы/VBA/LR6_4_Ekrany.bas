Attribute VB_Name = "LR6_4_Ekrany"
' =====================================================================
' ЛР6 «Электронный бизнес», NotaCode. Методика 6.4 Страницы и экраны.
' Выполнила: Хаджинова К.
' Назначение: заполнить Excel-шаблон «Шаблон_перехода_к_страницам_и_экранам.xlsx»
'   данными NotaCode из файла VBA\data\lr6_4.tsv (UTF-8, выгружен скриптом Python\lr6_calc.py),
...
'   2) Файл lr6_4.tsv ищется рядом с копией, в подпапке data; иначе макрос откроет диалог выбора.
'   3) Alt+F11 -> File -> Import File -> LR6_4_Ekrany.bas.
...
Public Sub Main()
    RunLoad "lr6_4.tsv"
    AddBarChart ActiveWorkbook.Worksheets(U("\u0414\u0430\u0448\u0431\u043E\u0440\u0434")), ActiveWorkbook.Worksheets(U("\u041F\u0440\u0438\u043E\u0440\u0438\u0442\u0438\u0437\u0430\u0446\u0438\u044F")), "A5:A28", "I5:I28", U("\u041F\u0440\u0438\u043E\u0440\u0438\u0442\u0435\u0442 \u0438\u043D\u0442\u0435\u0440\u0444\u0435\u0439\u0441\u043D\u044B\u0445 \u0435\u0434\u0438\u043D\u0438\u0446 (P1 >= 80)"), 420, 20
    MsgBox "LR6 LR6_4_Ekrany: OK", vbInformation
End Sub
